const { endPointEvents } = require('../../lib/endPointEvents');

let message = {
  "__type": "SetSlotEventsDataRequest", "timeStamp": "2020-01-24T15:58:57.405Z", "sender": { "__type": "BaseStamp", "name": "urano.apigateway", "id": null, "version": null }, "addressee": { "__type": "BaseStamp", "name": "urano.apigateway", "id": null, "version": null }, "sessionId": null, "body": { "__type": "EndpointPackageDTO", "type": "slotMeters", "timeStamp": "2019-12-19T13:06:34.677Z", "hallId": 31, "userId": 123456, "transactions": [{ "__type": "MetersTransactionDTO", "isRectification": false, "requestId": 1, "timeStamp": "2019-12-19T13:06:34.677Z", "slotId": "1234567", "currencyCode": "ARS", "billMeters": [{ "__type": "BillMeterDTO", "id": 100, "quantity": 10 }, { "__type": "BillMeterDTO", "id": 200, "quantity": 10 }], "gameMeters": { "__type": "GameMetersDTO", "ca": "10000", "cc": "500", "ci": "800000", "co": "100000", "cxb": "800000", "drop": "1000", "jj": "1000", "jp": "1000", "tci": "800000", "tco": "101000" }, "denomination": 0.01, "item": "0" }], "token": "string", "sign": "string" }, "correlationId": 1
};
...
test('get meter type', done => {
  getData(result => {
    expect(result.__type).toBe('SetSlotEventsDataResponse');
    done();
  });
});
...
/////////////////////////////////////////////////////////////////////////////////////
// Es necesario realizar una validacion real en endPointEvents para correr este test
/////////////////////////////////////////////////////////////////////////////////////
...
function getData(callback) {
  ...
  const result = endPointEvents(message);
  setTimeout(() => {
    callback(result);
  }, 2000);
}
